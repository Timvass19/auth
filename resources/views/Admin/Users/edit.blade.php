                ...
                <div class="card-body">
                   <form action=" {{route('admin.users.update', $user)}}" method="POST">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-md-6 col-form-label">{{ __('Nom utilisateur') }}</label>
                    ...
                    <div class="form-group form-check">
                        <input type="checkbox" name="roles[]" value=" {{$role->id}}" id="{{$role->id}}" @if ($user->roles->pluck('id')->contains($role->id)) checked @endif>
